...
int main(){
    ...
    cout<<"Время за 10'000 запусков при равномерном распределении для s_A для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t1_A, 8);
    cout<<"Время за 10'000 запусков при неравномерном распределении для s_A для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t2_A, 8);
    cout<<"\n";
    cout<<"Время за 10'000 запусков при равномерном распределении для s_B для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t1_B, 8);
    cout<<"Время за 10'000 запусков при неравномерном распределении для s_B для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t2_B, 8);
    cout<<"\n";

    cout<<"Время за 10'000 запусков при равномерном распределении для s_C для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t1_C, 8);
    cout<<"Время за 10'000 запусков при неравномерном распределении для s_B для длин 500, 1000, 10000, 40000, 100000,300000, 700000, 1000000 соответсвенно"<<endl;
    print_arr(t2_C, 8);
    cout<<"\n";
